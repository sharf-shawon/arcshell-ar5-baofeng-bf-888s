...
nav_order: 2
description: "Quick start guide for new owners of Arcshell AR-5 and BaoFeng BF-888S radios."
---
...
[Learn how to get licensed →](legal-and-licensing.md)
...
6. **Program Your Radio:** Use a programming cable and [CHIRP software](programming/index.md) to configure legal frequencies.
...
- [Learn about Programming with CHIRP →](programming/index.md)
- [See the Frequency Reference charts →](frequencies/index.md)
