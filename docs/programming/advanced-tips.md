...
parent: Programming
nav_order: 3
description: "Advanced CHIRP techniques for power users: bulk editing, shortcuts, and sharing configurations."
---

# 🚀 Advanced CHIRP Tips

Once you're comfortable with the basics, use these tips to speed up your workflow.
...
3.  Select **Edit** and change the value. It will apply to all selected channels.
...
- **VOX:** Disable this unless you are using a hands-free headset.
- **Beep:** Turn off that annoying "beep" every time you press a button.
