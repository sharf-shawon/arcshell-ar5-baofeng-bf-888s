# Contributing to the Radio Guide

First off, thank you for considering contributing to this project! It's people like you that make this a definitive resource for the community.
...
- **Tone:** Keep it beginner-friendly, helpful, and professional.
- **Images:** If adding images, place them in `assets/images/` and use descriptive alt text.
